...
for testSubNo in range(1,16):
    ...
    model = Sequential()
    model.add(GRU(1024, input_shape=(seqL, latdim)))
    ...
    if len(os.listdir(('savedgru/'))) != 0:
        model.load_weights('savedgru/')
...
sio.savemat('gru_personal_performance_ica.mat',
