...
for latdim=1:latdimNum
    for subNo=1:subNum      
        filename1 = strcat(strcat('D:\Processed SEED\AE\decoded_eegs_ae\decoded_eegs_ae_sub',num2str(subNo),'_latentdim',num2str(latdim),'.mat'));
...
fileName = strcat('D:\Processed SEED\Calculated\ae_reconstruction_corr_Rvalue.mat');
